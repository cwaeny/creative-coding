...
for (let x = 70; x <= 850; x = x + 100) {
  ...
  fill(0, 0, 0);
  noStroke();
  arc(x, 260, 100, 100, HALF_PI + PI, PI + TWO_PI + QUARTER_PI);

  fill('#ffdee2');
  stroke(1);
  strokeWeight(2);
  arc(x, 210, 100, 100, HALF_PI, PI + PI);
  ...
  fill(0, 0, 0);
  noStroke();
  arc(x, 560, 100, 100, HALF_PI + PI, PI + TWO_PI + QUARTER_PI);

  fill('#ffdee2');
  stroke(1);
  strokeWeight(2);
  arc(x, 510, 100, 100, HALF_PI, PI + PI);
